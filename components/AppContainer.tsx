...
interface Props {
    speechTopics : {id: number, topic :string}[]
}

export default function AppContainer({speechTopics}: Props) {
    ...
    function generateRandomTopic(): string {
        const randomIndex = Math.floor(Math.random() * speechTopics.length);
        return speechTopics[randomIndex].topic;
    }
